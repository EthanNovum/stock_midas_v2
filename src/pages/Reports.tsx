  ...
  return (
    <div className="max-w-7xl mx-auto space-y-10">
      ...
      <div className="flex justify-between items-end">
        ...
        <button className="flex items-center gap-2 px-6 py-3 bg-primary text-surface rounded-2xl font-bold hover:scale-105 active:scale-95 transition-all shadow-lg shadow-primary/20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-12 xl:col-span-5 space-y-5">
          <div className="flex items-center gap-4 mb-6">
            ...
            <button className="p-2.5 bg-surface-container-low rounded-xl border border-outline-variant/10 hover:bg-surface-dim transition-colors">
          ...
          {selectedReport ? (
            <div className="bg-surface-container-lowest rounded-[3rem] p-10 shadow-sm border border-outline-variant/10 h-full animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="space-y-6">
                ...
                <button className="mt-8 flex items-center gap-2 text-sm font-black text-primary hover:gap-4 transition-all group">
                  阅读全文报告
